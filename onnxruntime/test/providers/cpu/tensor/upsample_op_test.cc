...
TEST(UpsampleOpTest, UpsampleOpNearestTest_int32) {
  ...
  test.Run(OpTester::ExpectResult::kExpectSuccess, "", {}); // Unleash TRT EP test    //TensorRT: nvinfer1::query::Ports<nvinfer1::query::AbstractTensor>&): Assertion `!formats.empty()' failed
}
